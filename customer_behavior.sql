/*==============================================================================
CUSTOMER PERCHASE BEHAVIOUR ANALYSIS
TOOL: SQL
DATASET: customers tabe
 ==================================================================================*/
...
SELECT gender,
	SUM(purchase_amount) AS total_revenues
FROM  customers
    GROUP BY gender;
...
SELECT 
	item_purchased, 
	ROUND(AVG(review_rating), 1) AS `product Reting`
FROM customers
...
SELECT 
    CASE 
		WHEN previous_purchases > 5 THEN 'Repeat Buyer' ELSE 'Non-Repeat' END AS buyer_type,
    subscription_status,
